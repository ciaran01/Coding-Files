...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        neighbours = set()
        a, b = cell
        for i in range(max(0, (a-1)), min((a+2), self.height)):
            for j in range(max(0, (b-1)), min((b+2), self.width)):
                if (i, j) != cell:
        ...
        while loop:
            ...
            for sentence in self.knowledge:
                ...
                for s in self.safes:
                    if s in sentence.cells:
                        edits += 1
                    sentence.cells.discard(s)
            ...
            for sentence in self.knowledge:
                for sentenceB in self.knowledge:
                    if len(sentence.cells) == 0:
                        ...
                        edits += 1
                        break
                    if len(sentenceB.cells) == 0:
                        self.knowledge.remove(sentenceB)
                        edits += 1
                        break
